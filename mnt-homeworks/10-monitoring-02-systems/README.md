...
Необходимо утвердить SLA в рамках которого будут указаны SLO для требуемых метрик. Чтобы отслеживать фактический уровень обслуживания необходимо испольхзовать SLI.
